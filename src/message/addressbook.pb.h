...
Arena::CreateMaybeMessage<::tutorial::AddressBook>(Arena *);
template <>
...
constexpr int Person_PhoneType_PhoneType_ARRAYSIZE =
...
inline void Person::set_allocated_email(std::string *email) {
  ...
  email_.SetAllocatedNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), email);
  // @@protoc_insertion_point(field_set_allocated:tutorial.Person.email)
}

// repeated .tutorial.Person.PhoneNumber phones = 4;
inline int Person::_internal_phones_size() const { return phones_.size(); }
...
Person::_internal_phones(int index) const {
...
// repeated .tutorial.Person people = 1;
inline int AddressBook::_internal_people_size() const { return people_.size(); }
...
AddressBook::_internal_people(int index) const {
